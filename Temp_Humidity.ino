...
/* uses a dht11 temp & humidity sensor that checks the temperature, humidity and checksum of the values.
The code checks for 5 successive value readings with a time delay of about 2millisecinds. It can be adjusted to take continuous data*/
